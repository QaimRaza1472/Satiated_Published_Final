...
class AddYourIntention extends StatefulWidget {
  final String uid;
  final String wheelhead;

  AddYourIntention(this.uid, this.wheelhead);
  @override
  _AddYourIntentionState createState() => _AddYourIntentionState();
}

class _AddYourIntentionState extends State<AddYourIntention> {
...
// format date
  ...
  _filesDialog2(BuildContext context, String eventName) {
    showDialog(
        context: context,
        builder: (BuildContext context) {
          return StatefulBuilder(builder: (thisLowerContext, innerSetState) {
  ...
  //       Navigator.push(
  //         context,
  //         MaterialPageRoute(builder: (context) => BusyHours(widget.uid)),
  //       );
  //     },
  //   );
...
//   }
  void checkbusyhour() {
    if (busy_data == null || busy_data.isEmpty) {
      _filesDialog2(context, "Firstly add your schedule");
    }
  }
  ...
  void initState() {
    ...
    titleController.text = "";
    discriptionController.text = "";
    Timer(Duration(seconds: 2), checkbusyhour);
  }
                  ...
                  onTap: () async {
                    if (checkAlreadyData() == true) {
                      _filesDialog(context,
                          "Intentions Already Exist between selected time");
                    } else if (checkAlreadyDataOnBusyHour() == true) {
                      // _filesDialog(context, "Time exist  between busy hours");
